...
########################################################################################################
#title
label_title = Label(window, text="CENTRALIZED AUTOMATED ATTENDANCE MANAGEMENT SYSTEM",width=70  ,height=2 , bg='blue', fg='white' ,font=('times', 30, ' bold ') ) 
...
take_group_att_btn = Button(window, text="LOGIN", bg="red", fg="white", command=admin_area, font=('times', 20, ' bold '))
